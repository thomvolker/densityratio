...
spectral <- function(df_numerator, df_denominator, J = NULL, nsigma = 10,
                     sigma_quantile = NULL, sigma = NULL,
  ...
  dist_nu <- distance(nu, centers, FALSE)
  dist_de <- distance(centers, centers, FALSE)
