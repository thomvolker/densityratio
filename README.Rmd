...
hexSticker::sticker(
  ggplot() +
    ...
    theme(
      ...
      legend.position.inside = c(1.02, 0.53),
      legend.text = element_text(colour = "white", size = 40)
    ) +
...
We display `kliep()` and `naive()` as examples here. The other functions are displayed in the [Get Started vignette](https://thomvolker.github.io/densityratio/articles/densityratio.html). 
