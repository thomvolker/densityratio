...
```{r bandwidth-note, echo = FALSE, message=FALSE}
...
legend(
  "topleft",
  legend = c("Small bandwidth", "Large bandwidth"),
  col = c("navy", "orange"),
  pch = 1
)
```
...
```{r regularization-note, echo = FALSE, message=FALSE}
dr_large <- ulsif(
  hs_kid_score, 
  nhs_kid_score,
  sigma = 1,
...
legend(
  "topleft",
  legend = c("Small regularization parameter", "Large regularization parameter"),
  col = c("navy", "orange"),
  pch = 1
)
```
